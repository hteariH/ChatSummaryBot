...
| `SUMMARY_HOUR` | Daily summary hour (0-23) | `21` |
...
- `/sethour <hour>`: Sets a custom summary hour for the current chat (e.g., `/sethour 21` for daily summary at 21:00).
- `/setcron <cron>`: (Deprecated, use `/sethour`) Parses the hour from cron and sets daily summary hour.
