...
3. **`service/ChatConfigService`** — per-chat settings (summaryHour, language, custom prompt, enabled flag, monthly flag, summary credits, `lastProcessedAt`/`lastMonthlyProcessedAt`).
